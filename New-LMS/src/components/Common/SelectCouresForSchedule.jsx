          ...
          {fetchedCourseData?.map((elem) => {
            return (
              <div className="flex items-center justify-between bg-white p-4 rounded-md shadow-sm shadow-gray-300">
                ...
                <Link to={`${elem._id}`} className="bg-gray-900 text-white md:px-4 px-2 md:py-2 py-1 md:text-base text-sm rounded-md">Batches</Link>
              </div>)
          })}
        </div>
      </div>
...
export default SelectCouresForSchedule
