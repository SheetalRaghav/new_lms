    ...
    <div className='w-full lg:px-10 mt-5 px-5'>
      ...
      <section className="w-full px-4">
        <div className="flex items-center justify-center py-4 ">
          <div className="grid md:grid-cols-3 grid-cols-1 gap-4 md:w-auto w-full place-items-center">
            <Link to={'/register'} className='flex bg-blue-500 w-[170px] max-w-[170px] gap-2 shadow-md shadow-gray-400 text-white font-semibold text-lg justify-center items-center px-2 py-1 rounded-md' >
              <UserIcon className="h-4 w-4" />
              User
            </Link>
            <Link to={'/curriculum'} className='flex bg-blue-500 w-[170px] max-w-[170px] gap-2 shadow-md shadow-gray-400 text-white font-semibold text-lg justify-center items-center px-2 py-1 rounded-md' >
              <BookIcon className="h-4 w-4" />
              Curriculum
            </Link>
            <Link to={'/new-course'} className='flex bg-blue-500 w-[170px] max-w-[170px] gap-2 shadow-md shadow-gray-400 text-white font-semibold text-lg justify-center items-center px-2 py-1 rounded-md' >
      ...
      <div className="flex w-full justify-center items-center gap-5 flex-wrap ">
        <div className="flex-1 min-w-[250px] max sm:min-h-[200px] min-h-[180px] h-auto rounded-md shadow-md py-4 shadow-gray-400 backdrop-blur-md  cursor-pointer flex justify-between flex-col items-end px-4 " style={{ background: `url(${wave})` }}>
          ...
          <h3 className='text-2xl text-gray-600 font-semibold'>{fetchedUserData?.length}</h3>
        </div>
        <div className="flex-1 min-w-[250px] max sm:min-h-[200px] min-h-[180px] h-auto rounded-md shadow-md py-4 shadow-gray-400 backdrop-blur-md  cursor-pointer flex justify-between flex-col items-end px-4 " style={{ background: `url(${wave})` }}>
          ...
          <h3 className='text-2xl text-gray-600 font-semibold'>{fetchedCategoryData?.length}</h3>
        </div>
        <div className="flex-1 min-w-[250px] max sm:min-h-[200px] min-h-[180px] h-auto rounded-md shadow-md py-4 shadow-gray-400 backdrop-blur-md  cursor-pointer flex justify-between flex-col items-end px-4 " style={{ background: `url(${wave})` }}>
          ...
          <h3 className='text-2xl text-gray-600 font-semibold'>{fetchedCourseData?.length}</h3>
        </div>
